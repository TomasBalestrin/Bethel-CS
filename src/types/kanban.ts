...
export const MENTEE_SUMMARY_FIELDS = 'id, full_name, phone, email, instagram, product_name, city, state, status, cliente_fit, priority_level, kanban_type, current_stage_id, start_date, created_at, created_by, niche, closer_name, funnel_origin, birth_date, faturamento_atual, faturamento_antes_mentoria, notes' as const
